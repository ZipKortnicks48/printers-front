...
export class TableRequestStore {
    ...
    _filterClick = async () => {
        ...
        this.reqs = []
        let url = `req/?offset=${(this.page-1)*this.limit}&limit=${this.limit}&`
    ...
    getCabinets = async () => {
        ...
        await getRequest(`req/?limit=${this.limit}&offset=${(this.page-1)*this.limit}`, { resolve: this.successReqCallback, reject: this.errorCallback }, token)
    }
